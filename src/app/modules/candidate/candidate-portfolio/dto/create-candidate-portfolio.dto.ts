...
export class CreatePortfolioDto {
  ...
  @ApiPropertyOptional({
    description:
      'Detailed breakdown of text accomplishments or framework tools applied',
  ...
  @ApiPropertyOptional({
    description:
      'An optional live link to the deployed site or mockup container',
  ...
  @ApiProperty({
    ...
    format: 'binary',
    description:
      'The portfolio showcase visual image preview file to upload to cloud storage',
  })
  thumbnail: any;
}
