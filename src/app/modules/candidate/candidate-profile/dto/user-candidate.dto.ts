...
class CandidateProfileDto {
  ...
  @ApiPropertyOptional({
    example: '1998-04-23T00:00:00.000Z',
  ...
  @ApiPropertyOptional({
    ...
    description: 'Professional headline for the candidate',
  })
  headline: string | null;

  @ApiPropertyOptional({
    example: 'Passionate developer building scalable systems...',
    description: 'Brief bio or summary of the candidate',
  })
  bio: string | null;
  ...
  @ApiPropertyOptional({
    example: '2500.00',
    type: String,
    description: 'Current salary of the candidate',
  })
  ...
  @ApiPropertyOptional({
    example: '4500.00',
    type: String,
    description: 'Expected salary of the candidate',
  })
  expectedSalary: any | null;

  @ApiPropertyOptional({
    example: 'USD',
    description: 'Currency for the salary values',
  })
  ...
  @ApiPropertyOptional({
    enum: Availability,
    example: Availability.immediate,
    description: 'Availability status of the candidate',
  })
  ...
  @ApiPropertyOptional({
    ...
    description: 'Preferred work type of the candidate',
  })
  ...
  @ApiProperty({
    ...
    description: 'Visibility level of the candidate profile',
  })
  profileVisibility: ProfileVisibility;

  @ApiProperty({
    example: true,
    description: 'Indicates if the candidate is open to work opportunities',
  })
  openToWork: boolean;
}
...
export class UserCandidateDto {
  @ApiProperty({
    example: '37abb433-eec5-423c-80b3-18fe9f29ffce',
    description: 'Unique identifier for the user',
  })
  id: string;

  @ApiProperty({
    example: 'manzp@gmail.com',
  ...
  @ApiProperty({
    example: '2026-05-30T10:43:04.686Z',
