...
export class CreateCompanyDto {
  @ApiProperty({ example: 'Infinity Innovation', description: 'The official name of the company' })
  @IsString()
  name: string;

  @ApiPropertyOptional({ example: 'Building the future of recruitment software.' })
  @IsOptional()
  @IsString()
  description?: string;
  ...
  @ApiPropertyOptional({ example: '2020-01-01T00:00:00.000Z', description: 'When the company was founded' })
  @IsOptional()
  @IsDateString()
